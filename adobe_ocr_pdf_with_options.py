...
input_file = 'C:/Users/xx/Downloads/input_pdf/sentbyCA.pdf'
output_path = 'C:/Users/xx/Downloads/output_pdf/OcrPDFWithOptions'

# API INfo
os.environ['PDF_SERVICES_CLIENT_ID'] = 'udpate with yours'
os.environ['PDF_SERVICES_CLIENT_SECRET'] = 'update with yours'
...
class OcrPDFWithOptions:
    ...
    def create_output_file_path() -> str:
        ...
        return f"{output_path}/ocr{time_stamp}.pdf"
